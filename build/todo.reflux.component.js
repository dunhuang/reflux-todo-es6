...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoRefluxAction = __webpack_require__(63);

	var _todoRefluxAction2 = _interopRequireDefault(_todoRefluxAction);

	var _todoRefluxStore = __webpack_require__(64);

	var _todoRefluxStore2 = _interopRequireDefault(_todoRefluxStore);
	...
	var TodoItem = function (_Component) {
	  ...
	  _createClass(TodoItem, [{
	    ...
	    value: function handleToggle(evt) {
	      _todoRefluxAction2.default.toggleItem(this.props.id);
	    }
	  }, {
	    key: 'handleEditStart',
	    value: function handleEditStart(evt) {
	      ...
	      this.setState({
	        ...
	        _reactDom2.default.findDOMNode(this.refs.editInput).focus();
	      });
	    }
	  }, {
	    key: 'handleValueOnChange',
	    value: function handleValueOnChange(evt) {
	      var text = _reactDom2.default.findDOMNode(this.refs.editInput).value; // because of the linkState call in render, this is the contents of the field
	    ...
	    value: function handleValueChange(evt) {
	      ...
	      if (evt.which === 13 && text) {
	        _reactDom2.default.findDOMNode(this.refs.editInput).blur();
	      }
	    ...
	    value: function handleBlur() {
	      ...
	      if (this.state.isEditing && text) {
	        _todoRefluxAction2.default.editItem(this.props.id, text);
	      }
	    ...
	    value: function handleDestroy() {
	      _todoRefluxAction2.default.removeItem(this.props.id);
	    }
	  }, {
	    key: 'render',
	...
	var TodoMain = function (_Component2) {
	  ...
	  _createClass(TodoMain, [{
	    ...
	    // },
	    value: function toggleAll(evt) {
	      _todoRefluxAction2.default.toggleAllItems(evt.target.checked);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      switch (this.props.location.pathname + this.props.location.search) {
	        case '/completed':
	          filteredList = this.props.list.filter(function (item) {
	...
	var TodoHeader = function (_Component3) {
	  _inherits(TodoHeader, _Component3);
	  ...
	  _createClass(TodoHeader, [{
	    ...
	    value: function handleValueChange(evt) {
	      ...
	      if (evt.which === 13 && text) {
	        ...
	        _todoRefluxAction2.default.addItem(text);
	        evt.target.value = '';
	      } else if (evt.which === 27) {
	...
	var TodoFooter = function (_Component4) {
	  ...
	  _createClass(TodoFooter, [{
	    key: 'render',
	    value: function render() {
	      var nbrcompleted = this.props.list.filter(function (item) {
	        return item.isComplete;
	      }).length,
	          nbrtotal = this.props.list.length,
	          nbrincomplete = nbrtotal - nbrcompleted,
	          clearButtonClass = (0, _classnames2.default)({ 'clear-completed': true, hidden: nbrcompleted < 1 }),
	...
	var TodoApp = function (_Component5) {
	  ...
	  function TodoApp(props) {
	    ...
	    var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(TodoApp).call(this, props));

	    _this5.state = {
	      list: _todoRefluxStore2.default.getInitialState()
	    };
	    return _this5;
	  }
	  ...
	  _createClass(TodoApp, [{
	    ...
	    value: function componentDidMount() {
	      this.unsubscribe = _todoRefluxStore2.default.listen(this.onChange.bind(this));
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routerWarning = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoActions = _reflux2.default.createActions(["toggleItem", // called by button in TodoItem
...
/***/ function(module, exports, __webpack_require__) {
	...
	var todoListStore = _reflux2.default.createStore({
	    // this will set up listeners to all publishers in TodoActions, using onKeyname (or keyname) as callbacks
	    listenables: [_todoRefluxAction2.default],
	    onEditItem: function onEditItem(itemKey, newLabel) {
	    ...
	    onRemoveItem: function onRemoveItem(itemKey) {
	        this.updateList(this.list.filter(function (item) {
	            return item.key !== itemKey;
	        }));
	    },
	    onToggleItem: function onToggleItem(itemKey) {
	        var foundItem = getItemByKey(this.list, itemKey);
	        if (foundItem) {
	    ...
	    onToggleAllItems: function onToggleAllItems(checked) {
	        this.updateList(this.list.map(function (item) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./todo.reflux.component.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./todo.reflux.component.css");
